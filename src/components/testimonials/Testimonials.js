  ...
  const testimonials = [
    {
      ...
      test: 'As a developer and a problem solver, I think sukeerthan is a great collaborative partner to have. I met sukeerthan in some basic javascript & react projects and since then he has drastically progressed in him understanding of the development process. He always has a professional environment and has good audio and video quality which makes it easier to communicate with him.',
    },
    {
      id: 2,
      link: '',
